// === Oefening 1: querySelector() ===
{
   ...
   const vaasImg = document.querySelector('#ex1-html #vaas');
   console.log(vaasImg);

   const lijstje = document.querySelector('#ex1-html .kenmerken');
   console.log(lijstje);

   const nthChildList = document.querySelector('#ex1-html .kenmerken li:nth-child(2)')
   console.log(nthChildList);
}
