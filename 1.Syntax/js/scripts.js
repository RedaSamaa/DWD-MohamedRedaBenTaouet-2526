...
console.log('\n%c=== Console meldingen ===', 'color: #0c0');
{
	...
	console.error('Console opdracht: fout');
}
...
console.log('\n%c=== Console opmaak ===', 'color: #0c0');
{
	...
	console.log('%cDit is blauw op geel met padding', 'color: #00f; background-color: rgb(228, 228, 115); padding: 2px');
	console.log('%cDeze tekst bevat een %cpaars %cwoord', 'color: black;', 'color: purple;', 'color: black;');;
}
